...
export class CFAPIService {
    ...
    getAssetPresignedUrl(payload: any) {
      return this._httpClient.post<ApiResponse<any>>(`${this._baseUrl}/asset/v2/assets/get-presigned-url`, payload, { headers: this.getRequestHeaders() });
    }

    getTaskExpectedOutputName(taskId: string) {
      return this._httpClient.get<ApiResponse<any>>(`${this._baseUrl}/workflow/v2/internalpostproduction/${taskId}/expectedoutputname`, { headers: this.getRequestHeaders() });
    }
